...
Scene.GameScene.prototype = {
    ...
    create : function() {
        ...
        this.player1.body.setCollisionGroup(this.game.playerCollisionGroup);
        this.player1.body.collides(this.game.scorpionCollisionGroup, this.onLose, this);
...
this.scorpion.update(this.player1);
},
